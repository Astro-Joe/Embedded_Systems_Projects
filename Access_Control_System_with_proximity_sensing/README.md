# Access Control System with Proximity Sensing

## 📌 Overview
This project implements an access control system that uses an HC-SR04 ultrasonic sensor or proximity detection and integrates user authentication via a keypad,
